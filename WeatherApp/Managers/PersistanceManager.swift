...
//    static func updateFavourties(favourite:WeatherModel?,actionType:PersistenceActionType,completed: @escaping(Error?) -> Void){
//
...
//            switch result{
//                case .success(let favourties):
//                    var retreivedFavoutires = favourties
//                    switch actionType {
//                        case .add:
//                            guard !checkIfCityAddedAsFavourtie(cityName: favourite.name, favouritesList: retreivedFavoutires) else {
//                                completed(ErrorMessages.alreadyInFavourite)
//                                return
//                            }
//                            retreivedFavoutires.append(favourite)
//                        case .delete :
//                            retreivedFavoutires.removeAll {$0.name == favourite.name}
//                            }
//                completed(addFavourites(weatherData: retreivedFavoutires))
...
//    static func retrieveFavourites(completed : @escaping(Result<[WeatherModel],ErrorMessages>) -> Void){
...
//            let favourties = try decoder.decode([WeatherModel].self, from: favourtiesData)
...
//    static func addFavourites(weatherData:[WeatherModel]) -> ErrorMessages? {
//        do {
...
//
//
//    static func checkIfCityAddedAsFavourtie(cityName:String,favouritesList:[WeatherModel]) -> Bool {
//        for cityDetail in favouritesList{
//            if cityDetail.name == cityName {
//                return true
//            }
//        }
//        return false
